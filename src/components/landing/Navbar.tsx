...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`lp-navbar__mobile-overlay ${mobileMenuOpen ? "lp-navbar__mobile-overlay--visible" : ""}`}
        onClick={closeMobileMenu}
      />

      {/* Mobile Menu */}
      <div className={`lp-navbar__mobile-menu ${mobileMenuOpen ? "lp-navbar__mobile-menu--open" : ""}`}>
        <button
        ...
        <a href="#ozellikler" className="lp-navbar__mobile-link" onClick={closeMobileMenu}>
          Özellikler
        </a>
        <a href="#nasil-calisir" className="lp-navbar__mobile-link" onClick={closeMobileMenu}>
          Nasıl Çalışır?
        </a>
        <a href="#guvenlik" className="lp-navbar__mobile-link" onClick={closeMobileMenu}>
          Güvenlik
        </a>
        <a href="#fiyatlandirma" className="lp-navbar__mobile-link" onClick={closeMobileMenu}>
          Fiyatlandırma
        </a>
        ...
        <div style={{ marginTop: "auto", display: "flex", flexDirection: "column", gap: "12px" }}>
          {user ? (
            ...
            <>
              <Link href="/login" className="btn btn-ghost" onClick={closeMobileMenu}>
                Giriş Yap
              </Link>
              <Link href="/demo/request" className="btn btn-primary" onClick={closeMobileMenu}>
                Demo Talep Et
              </Link>
            </>
          )}
